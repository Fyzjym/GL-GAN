...
class SS2D(nn.Module, mamba_init):
    def __init__(
        ...
        **kwargs,
        ...
        # print("0 d_model：{}.".format(d_model))
    ...
    def __initv2__(
        ...
        **kwargs,    
        ...
        super().__init__()
        d_inner = int(ssm_ratio * d_model)
        # print("1 ssm_ratio：{}.".format(ssm_ratio))
        # print("1 d_model：{}.".format(d_model))
        #
        # print("1 d_inner：{}.".format(d_inner))
        ...
        self.act: nn.Module = act_layer()
        # print("2 d_model：{}.".format(d_model))

        # print("2 d_inner：{}.".format(d_inner))
...
class VSSBlock(nn.Module):
    ...
    def _forward(self, input: torch.Tensor):
        # print('block input:{}'.format(input.shape))
        if self.ssm_branch:
            if self.post_norm:
...
class VSSM(nn.Module):
    def __init__(
        self, 
        patch_size=4, 
        in_chans=1, #   in_chans=3, 
        num_classes=1000, 
        depths=[2, 2, 2, 2],         # depths=[2, 2, 9, 2],

        dims=[64, 128, 256, 512], # [96, 192, 384, 512] dims=[96, 192, 384, 768],
        # =========================
        ssm_d_state=16,
        ssm_ratio=2.0,
        ssm_dt_rank="auto",
