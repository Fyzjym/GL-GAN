from models.model import GL_GAN
import argparse
import torch
import collections
...
if __name__ == '__main__':
    ...
    parser.add_argument("-s", "--style-folder", type=str)
    parser.add_argument("-t", "--text", default='happy day', type=str)
    parser.add_argument("--text-path", default=None, type=str, help='Path to text file with texts to generate')
    parser.add_argument("-c", "--checkpoint", default='files/model.pth', type=str)
    ...
    writer = GL_GAN_writer(args.checkpoint, fake_args)
